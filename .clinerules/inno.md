...
- Python: 3.12+ (prefer 3.13+ when possible)
...
- directory structure that facilitates good pythin practices, sepetrate out documenttion, clients, services, tests etc
- Source layout:
...
- do not hardcode stuff in code.
- use yaml file for all 
  - constants
  - prompts
  - configurations
  - urls etc
